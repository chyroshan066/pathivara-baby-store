...
const HERODETAILS: HeroDetail[] = [
    {
        ...
        text: "Shop baby clothes, diapers, hospital bags, and all the essentials your little one needs.",
        icon: "#bag-heart",
    },
    {
...
export const Hero = memo(() => (
    <section style={{
        ...
        <div className="container-lg">
                ...
                <div className="col-lg-6 py-5 my-5">
                    <h2 className={`display-2 text-capitalize ${dmSans.className}`}>
                        <span className="fw-medium">
                            Discover </span>the softest <span className="fw-medium text-primary">Baby Essentials
                        </span>
                    </h2>
            ...
            <div className={`row row-cols-1 row-cols-sm-3 row-cols-lg-3 g-0 justify-content-center ${styles.shadow}`}>
                {HERODETAILS.map((detail, index) => (
                    <div
                        key={index}
                        className="col d-flex"
                    >
                        <div className={`${styles.card} border-0 ${index === 1 && " border-light-subtle border-start border-end"} bg-white rounded-0 p-5 text-dark w-100`}>
                            <div className="row">
