...
export const metadata: Metadata = {
  ...
  metadataBase: new URL("https://pathivarababystore.com.np"),
  alternates: {
    canonical: "/",
  },
  robots: {
      ...
      <head>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify(babyStoreStructuredData),
          }}
        />
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify(babyProductCategoriesStructuredData),
          }}
        />
      </head>
